...
public class PluginThermalExpansion extends PEIPlugin {
    public PluginThermalExpansion(String modid, Configuration config) { super(modid, config); }
    ...
    private class SmelterMapper extends PEIMapper {
        ...
        public void setup() {
            for (SmelterManager.SmelterRecipe recipe : SmelterManager.getRecipeList()) {
                addRecipe(recipe.getPrimaryOutput(), recipe.getPrimaryInput(), recipe.getSecondaryInput()); //TODO: Secondary Outputs
            }
        }
    }
