...
## [5.3.5]
### Fixed
- Using the wrong package in Blue Skies addon which caused problems in a dedicated server

## [5.3.4]
### Added
- Support for [Blood Magic], [Ex Nihilio Sequentia] and [Industrial Foregoing]
...
[Unreleased]: https://github.com/TagnumElite/ProjectE-Integration/compare/v5.6.2...HEAD
[5.6.2]: https://github.com/TagnumElite/ProjectE-Integration/compare/v5.6.0...v5.6.2
[5.6.0]: https://github.com/TagnumElite/ProjectE-Integration/compare/v5.5.0...v5.6.0
...
[5.3.4]: https://github.com/TagnumElite/ProjectE-Integration/compare/v5.3.2...v5.3.4
